...
print ("Connected to domain, attempting to stop '" + instance + "'")
try:
	print("Stoping Server "+instance+"")
	shutdown(instance, 'Server', 'true', 1000, block='false')
except:
	print("Error stopping Server" + instance)

...
curl -v -X GET -H "X-Auth-Token: ${authtoken}" -o downloaded_key_rsa  https://${identitydomain}.storage.oraclecloud.com/v1/Storage-${identitydomain}/${storagename}/id_rsa 

curl -v -X GET -H "X-Auth-Token: ${authtoken}"  -o downloaded_key_rsa.pub  https://${identitydomain}.storage.oraclecloud.com/v1/Storage-${identitydomain}/${storagename}/id_rsa.pub
